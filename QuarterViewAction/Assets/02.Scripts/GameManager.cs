...
public class GameManager : MonoBehaviour
{
    ...
    public void GameOver()
    {
        ...
        curScoreText.text = curScoreTxt.text;
    ...
    {
        // 상단 UI
        curScoreTxt.text = string.Format("{0:n0}", player.score);
        ...
        playerAmmoTxt.text = (player.equipWeapon == null || player.equipWeapon.type == Weapon.Type.Melee) ? "- / " + player.ammo : player.equipWeapon.curAmmo + " / " + player.ammo;
        ...
        weaponImgR.color = new Color(1, 1, 1, player.hasGrenades > 0 ? 1 : 0);
